          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-2">
                <Phone size={16} />
                <a href="tel:92486555" className="hover:text-accent transition-colors">
                  924 86 555
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail size={16} />
                <a href="mailto:post@rpr.no" className="hover:text-accent transition-colors">
                  post@rpr.no
                </a>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
            ...
            <div className="flex gap-6">
              <Link href="/personvern" className="hover:text-accent transition-colors">
                Personvernerklæring
              </Link>
